...
public class GuiAntiPacketsServer
extends GuiScreen
implements GuiYesNoCallback {
    private static GuiAntiPacketsServer INSTANCE;
    ...
    public GuiAntiPacketsServer(GuiScreen screen) {
        INSTANCE = this;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        String title = "Cancellable Server Packets";
        ...
        for (SettingBoolean setting : SettingManager.getSettingBooleans()) {
            if (!setting.getModName().equals("AntiPacketsServer") || setting.getName().equals("Toggled")) continue;
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        for (SettingBoolean setting : SettingManager.getSettingBooleans()) {
            for (GuiButton button : this.buttonList) {
                if (!button.mousePressed(Globals.MC, mouseX, mouseY) || !setting.getModName().equals("AntiPacketsServer") || setting.getName().equals("Toggled") || !setting.getName().equals(button.displayString)) continue;
    ...
    public static GuiAntiPacketsServer getInstance() {
        return INSTANCE;
    }
}
