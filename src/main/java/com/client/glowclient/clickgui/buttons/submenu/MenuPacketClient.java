...
import com.client.glowclient.clickgui.subguis.GuiAntiPackets;
import com.client.glowclient.utils.client.Globals;
import net.minecraft.client.gui.GuiScreen;

public class MenuPacketClient
extends SubMenu {
    public MenuPacketClient(Button parent, String guiName, String guiDesc) {
    ...
    public void processMouseClick(int mouseX, int mouseY, int button) {
        ...
        if (this.isMouseHovered() && button == 0) {
            Globals.MC.displayGuiScreen((GuiScreen)new GuiAntiPackets(ClickGUI.getInstance()));
        }
    }
}
